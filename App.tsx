...
// Función de utilidad para crear un stock con todos los valores a 0
// ❌ ELIMINADO: El parámetro 'mainLocationStock' para forzar stock 0.
const buildStock = () => ({
  ...initialStockByLocation,
  // Ya no se necesita sobrescribir, todos son 0 por defecto.
});

// ----------------------------------------------------
// 💥 CORRECCIÓN: initialInventoryItems ahora tienen stock 0
// ----------------------------------------------------
const initialInventoryItems: InventoryItem[] = [
  // Vodka
  {
    ...
    name: "Absolut",
    category: "🧊 Vodka",
    stockByLocation: buildStock(), // Stock 0
  },
  {
    id: "a2",
    name: "Beluga",
...
const App: React.FC = () => {
  ...
  const [inventoryItems, setInventoryItems] = useState<InventoryItem[]>(
    initialInventoryItems // Ahora initialInventoryItems tiene stock 0
  );
